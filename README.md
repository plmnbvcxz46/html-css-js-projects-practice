# 50 个项目，50 天 - HTML/CSS 和 JavaScript
...
4. - [x] **隐藏搜索小部件**
   <details>
        ...
        主要区别就是我用的 transform 来调节，然后教程用的 flex 布局，transform 会影响 radius（虽然最后也没写:) ）
    </details>
...
5. - [x] **模糊加载**
   <details>
        <summary>查看笔记</summary>
        主要的区别就是两个的变化函数不一样，然后模糊会有背景遮罩问题，教程用 cal 来扩大并且用 relative 调整位置，我直接改变背景色
   </details>
...
28. - [ ] **Github 个人资料**
    ...
    - 项目地址: [Github 个人资料](./github-profiles/index.html)
...
**关于拉取请求的说明**：所有这些项目都是课程的一部分。虽然我很感激人们尝试使某些东西更美观或添加新功能，但我们只接受拉取请求，并查看与课程保持一致的代码问题
